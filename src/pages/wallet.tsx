...
export default function Wallet() {
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      if (res.ok) {
        // 🔥 FIX: 0.8 ko 0.85 kar diya for 15% platform fee matching
        toast({ title: "Withdrawal Requested!", description: "Request sent! Rs " + (amount * 0.85) + " will be credited to your UPI within 24-48 hours (max 7 days for security check)." });
