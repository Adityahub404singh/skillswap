...
export default function BookSession() {
  ...
  function handleBook() {
    ...
    bookMut.mutate({ data: { mentorId: selectedMentorId!, skill: skill.trim(), sessionType: selectedType, scheduledDate: new Date(`${date}T${time}:00`).toISOString(), message: message || undefined } } as any);
  }
